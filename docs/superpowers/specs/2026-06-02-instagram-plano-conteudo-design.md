# Plano de Conteúdo — Instagram do Caminhos do Contemporâneo
**Data:** 2026-06-02
**Evento:** 7º Seminário Caminhos do Contemporâneo
**Período:** 05/06/2026 a 22/08/2026
...
- Verde musgo e terracota como cores de destaque
...
- Direcionamento de arte geral
- Copy por tela (para carrosséis)
...
**Fixas — todos os posts:**
`#CaminhosDoContemporâneo #7Caminhos #LabMAES`

**De apoio — por relevância:**
`#UDESCCEART #Florianópolis #SeminárioDeArtes #ArteContemporânea #PesquisaEmArte #EducaçãoArtística #Têxtil #Audiovisual`
...
| Data | Marco |
|------|-------|
| 30/06/2026 | Prazo de submissão de trabalhos |
| 13/07/2026 | Resultado das avaliações |
| 01/08/2026 | Prazo final de inscrições nas oficinas |
| 10/08/2026 | Lista de inscritos nas oficinas |
| 19–22/08/2026 | Evento |

---

## Estrutura do Calendário

### Fase 1 — Apresentação do universo (posts 1–3)
### Fase 2 — Prazo + último eixo (posts 4–5)
### Fase 3 — Conteúdos e pessoas (posts 6–10)
### Fase 4 — Contagem regressiva (post 11)
### Semana do evento — posts diários (posts 12–17)
...
- Copy: `7º Seminário Caminhos do Contemporâneo` / `Criação, tessituras sensíveis e narrativas em movimento` / `19 a 22 de agosto de 2026 · Florianópolis · Híbrido`

**TELA 2 — A obra**
- Arte: Reprodução de *Rio Doce* (Nara Guichon, 2022) centralizada. Crédito no rodapé: *"Rio Doce, 2022 · Nara Guichon"*. Fundo creme.
- Copy: `A identidade visual desta edição nasce de uma obra.` / `Rio Doce (2022)` / `Nara Guichon`
...
- Copy: `Eixo 2` / `Tessituras Sensíveis`
...
- Copy: `Eixo 3` / `Narrativas em Movimento`
...
**TELA 1**
- Arte: Foto com tratamento visual do KV. Tag "CONFERÊNCIA DE ABERTURA" em destaque.
- Copy: `Conferência de Abertura` / `Prof. Dra. Myriam Lemonchois`

**TELA 2**
- Arte: Fundo creme. Texto com área de pesquisa ou citação da pesquisadora.
...
**TELA 1**
- Arte: Foto com tratamento visual do KV. Tag "CONFERÊNCIA".
- Copy: `Conferência` / `Prof. Dr. Mario Barro Hérnandez`

**TELA 2**
- Arte: Fundo creme. Texto com área de pesquisa.
- Copy: `[mini-bio — 3-4 linhas, escritas pela equipe]`
...
**TELA 4 — Oficina 3**
- Arte: Elemento visual que remeta à linha no espaço, ao desenho performático.
...
**TELA 1**
- Arte: Foto com tratamento visual do KV. Tag "CONFERÊNCIA".
- Copy: `Conferência` / `Prof. Dra. Mónica Faria`
...
- Copy: `Mesas Redondas` / `Debates em torno dos três eixos` / `Presencial + Online`

**TELA 2 — Criação / Economia Criativa**
- Arte: Verde musgo como cor dominante (eixo Criação).
- Copy: `Criação & Economia Criativa` / `Sessões presenciais · Auditório` / `19 e 20 de agosto`

**TELA 3 — Tessituras / Educação Básica**
- Arte: Terracota como cor dominante (eixo Tessituras).
...
- Copy: `Esta semana` / `7º Seminário Caminhos do Contemporâneo` / `19 a 22 de agosto`

**TELA 2 — Qua 19 e Qui 20**
- Arte: Fundo creme com marcação dos dias em verde musgo.
- Copy: `Qua 19 · Qui 20` / `Conferências: Lemonchois · Barro Hérnandez` / `Abertura da Mostra Audiovisual · Exposição The Rotfather · Oficinas`

**TELA 3 — Sex 21**
- Arte: Fundo creme com terracota para o dia 3. Destaque para o Desfile Rotfather à noite.
...
Os seguintes itens precisam ser fornecidos pela equipe antes da produção dos posts 6, 7 e 9:

1. **Foto da Prof. Dra. Myriam Lemonchois** + mini-bio (área de pesquisa, instituição, conexão com o tema do evento) — para o post de 10/07
2. **Foto do Prof. Dr. Mario Barro Hérnandez** + mini-bio — para o post de 17/07
3. **Foto da Prof. Dra. Mónica Faria** + mini-bio — para o post de 31/07
