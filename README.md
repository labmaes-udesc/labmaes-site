...
- **Auto-hospedar Poppins e DM Mono** (como já feito com a Thunder) — o Google Fonts via CDN é problema de GDPR para público francês (decisão CNIL) e é CSS render-blocking de terceiro.
